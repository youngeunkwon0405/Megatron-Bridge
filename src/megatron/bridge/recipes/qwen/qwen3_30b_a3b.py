...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen3 30B-A3B MoE model.
    ...
    cfg = ConfigContainer(
        ...
        tokenizer=TokenizerConfig(tokenizer_type="HuggingFaceTokenizer", tokenizer_model="Qwen/Qwen3-30B-A3B"),
