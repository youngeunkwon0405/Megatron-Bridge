...
def model_config(
    ...
    """
    Configure the Qwen2.5 1.5B model.
    ...
    Returns:
        Qwen25ModelProvider1P5B: Configuration for the Qwen2.5 1.5B model.
    """
    return Qwen25ModelProvider1P5B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen2.5 1.5B model.
