...
def model_config(
    ...
    Returns:
        Qwen3ModelProvider4B: Configuration for the Qwen3 4B model.
    """
    return Qwen3ModelProvider4B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen3 4B model.
    ...
    cfg = ConfigContainer(
        ...
        tokenizer=TokenizerConfig(tokenizer_type="HuggingFaceTokenizer", tokenizer_model="Qwen/Qwen3-4B"),
