...
def model_config(
    ...
    """
    Configure the Qwen2.5 72B model.
    ...
    Returns:
        Qwen25ModelProvider72B: Configuration for the Qwen2.5 72B model.
    """
    return Qwen25ModelProvider72B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen2.5 72B model. The default configuration is for 4 nodes with 8 GPUs per node.
