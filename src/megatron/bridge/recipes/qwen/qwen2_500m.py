...
def model_config(
    ...
    """
    Configure the Qwen2 500M model.
    ...
    Returns:
        Qwen2ModelProvider500M: Configuration for the Qwen2 500M model.
    """
    return Qwen2ModelProvider500M(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen2 500M model.
