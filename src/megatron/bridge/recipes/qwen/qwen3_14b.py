...
def model_config(
    ...
    Returns:
        Qwen3ModelProvider14B: Configuration for the Qwen3 14B model.
    """
    return Qwen3ModelProvider14B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen3 14B model.
    ...
    cfg = ConfigContainer(
        ...
        tokenizer=TokenizerConfig(tokenizer_type="HuggingFaceTokenizer", tokenizer_model="Qwen/Qwen3-14B"),
