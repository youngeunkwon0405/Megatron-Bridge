...
def model_config(
    ...
    Returns:
        Qwen3ModelProvider8B: Configuration for the Qwen3 8B model.
    """
    return Qwen3ModelProvider8B(
...
def pretrain_config(
    ...
    cfg = ConfigContainer(
        ...
        tokenizer=TokenizerConfig(tokenizer_type="HuggingFaceTokenizer", tokenizer_model="Qwen/Qwen3-8B"),
