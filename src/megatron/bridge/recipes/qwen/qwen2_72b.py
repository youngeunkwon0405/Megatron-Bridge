...
def model_config(
    ...
    Returns:
        Qwen2ModelProvider72B: Configuration for the Qwen2 72B model.
    """
    return Qwen2ModelProvider72B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen2 72B model. The default configuration is for 4 nodes with 8 GPUs per node.
