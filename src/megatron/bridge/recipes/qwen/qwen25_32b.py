...
def model_config(
    ...
    """
    Configure the Qwen2.5 32B model.
    ...
    Returns:
        Qwen25ModelProvider32B: Configuration for the Qwen2.5 32B model.
    """
    return Qwen25ModelProvider32B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen2.5 32B model. The default configuration is for 2 nodes with 8 GPUs per node.
