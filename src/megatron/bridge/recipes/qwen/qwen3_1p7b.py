...
def model_config(
    ...
    """
    Configure the Qwen3 1.7B model.
    ...
    Returns:
        Qwen3ModelProvider1P7B: Configuration for the Qwen3 1.7B model.
    """
    return Qwen3ModelProvider1P7B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen3 1.7B model.
    ...
    cfg = ConfigContainer(
        ...
        tokenizer=TokenizerConfig(tokenizer_type="HuggingFaceTokenizer", tokenizer_model="Qwen/Qwen3-1.7B"),
