...
def model_config(
    ...
    Returns:
        Qwen3ModelProvider32B: Configuration for the Qwen3 32B model.
    """
    model_cfg = Qwen3ModelProvider32B(
...
def pretrain_config(
    ...
    """
    Create a pre-training configuration for Qwen3 32B model. The default configuration is for 2 nodes with 8 GPUs per node.
    ...
    cfg = ConfigContainer(
        ...
        tokenizer=TokenizerConfig(tokenizer_type="HuggingFaceTokenizer", tokenizer_model="Qwen/Qwen3-32B"),
