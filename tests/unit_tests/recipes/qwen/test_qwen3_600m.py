...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Qwen3ModelProvider600M)
        assert config.tensor_model_parallel_size == 1  # Default for Qwen3 600M model
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Qwen3ModelProvider600M)
        ...
        # Check model configuration (Qwen3 600M specific defaults)
        assert config.model.tensor_model_parallel_size == 1  # Default for Qwen3 600M model
