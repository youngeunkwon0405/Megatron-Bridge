...
class TestPretrainConfig:
    ...
    def test_pretrain_config_scheduler_configuration(self):
        ...
        assert config.scheduler.lr_warmup_iters == 500  # default for qwen2_72b
    ...
    def test_pretrain_config_72b_specific_defaults(self):
        """Test that 72B model has appropriate defaults for its size."""
        config = pretrain_config()

        # 72B model should default to high parallelism for efficiency
