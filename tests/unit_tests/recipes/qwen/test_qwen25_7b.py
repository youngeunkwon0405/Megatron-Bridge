...
from megatron.bridge.models.qwen import Qwen25ModelProvider7B
from megatron.bridge.recipes.qwen.qwen25_7b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Qwen25ModelProvider7B)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Qwen25ModelProvider7B)
    ...
    def test_pretrain_config_scheduler_configuration(self):
        ...
        assert config.scheduler.lr_warmup_iters == 500  # default for qwen25_7b
