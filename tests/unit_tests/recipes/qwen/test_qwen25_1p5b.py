...
from megatron.bridge.models.qwen import Qwen25ModelProvider1P5B
from megatron.bridge.recipes.qwen.qwen25_1p5b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Qwen25ModelProvider1P5B)
        assert config.tensor_model_parallel_size == 1  # Default for 1.5B model
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Qwen25ModelProvider1P5B)
        ...
        # Check model configuration (1.5B specific defaults)
        assert config.model.tensor_model_parallel_size == 1  # Default for 1.5B model
    ...
    def test_pretrain_config_scheduler_configuration(self):
        ...
        assert config.scheduler.lr_warmup_iters == 500  # default for qwen25_1p5b
