...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        # Check model configuration (Qwen3 1.7B specific defaults)
        assert config.model.tensor_model_parallel_size == 1  # Default for Qwen3 1.7B model
    ...
    def test_pretrain_config_scheduler_configuration(self):
        ...
        assert config.scheduler.lr_warmup_iters == 500  # default for qwen3_1p7b
