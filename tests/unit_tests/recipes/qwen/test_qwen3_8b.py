...
from megatron.bridge.models.qwen import Qwen3ModelProvider8B
from megatron.bridge.recipes.qwen.qwen3_8b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Qwen3ModelProvider8B)
        assert config.tensor_model_parallel_size == 4  # Default for Qwen3 8B model
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Qwen3ModelProvider8B)
        ...
        # Check model configuration (Qwen3 8B specific defaults)
        assert config.model.tensor_model_parallel_size == 4  # Default for Qwen3 8B model
    ...
    def test_pretrain_config_tokenizer_configuration(self):
        ...
        assert config.tokenizer.tokenizer_model == "Qwen/Qwen3-8B"
