...
from megatron.bridge.models.qwen import Qwen3ModelProvider14B
from megatron.bridge.recipes.qwen.qwen3_14b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Qwen3ModelProvider14B)
        assert config.tensor_model_parallel_size == 8  # Default for Qwen3 14B model
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Qwen3ModelProvider14B)
        ...
        # Check model configuration (Qwen3 14B specific defaults)
        assert config.model.tensor_model_parallel_size == 8  # Default for Qwen3 14B model
    ...
    def test_pretrain_config_scheduler_configuration(self):
        ...
        assert config.scheduler.lr_warmup_iters == 500  # default for qwen3_14b
    ...
    def test_pretrain_config_tokenizer_configuration(self):
        ...
        assert config.tokenizer.tokenizer_model == "Qwen/Qwen3-14B"
