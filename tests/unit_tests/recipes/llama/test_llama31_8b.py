...
from megatron.hub.recipes.llama.llama31_8b import model_config, pretrain_config
...
class TestModelConfig:
    ...
    def test_model_config_default_parameters(self):
        ...
        assert isinstance(config, Llama31ModelProvider8B)
...
class TestPretrainConfig:
    ...
    def test_pretrain_config_default_parameters(self):
        ...
        assert isinstance(config.model, Llama31ModelProvider8B)
    ...
    def test_pretrain_config_custom_training_parameters(self):
        ...
        assert config.dataset.sequence_length == 8192  # Always 8192 for Llama3.1 8B
    ...
    def test_pretrain_config_llama31_defaults(self):
        """Test that Llama3.1 8B specific defaults are applied correctly."""
        config = pretrain_config()
        ...
        assert config.dataset.sequence_length == 8192  # Standard 8k sequence length
