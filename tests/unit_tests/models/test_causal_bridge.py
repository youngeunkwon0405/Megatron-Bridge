...
class TestCausalLMBridge:
    ...
    def test_from_hf_pretrained_with_model_id(self):
        ...
        with patch("megatron.bridge.models.causal_bridge.PreTrainedCausalLM.from_pretrained") as mock_from_pretrained:
            # Set up the from_pretrained class method properly
            mock_from_pretrained.return_value = mock_model

            with patch("megatron.bridge.models.causal_bridge.AutoConfig") as mock_autoconfig:
...
class TestCausalLMBridgeEdgeCases:
    ...
    def test_list_supported_models(self):
        ...
        with patch("megatron.bridge.models.causal_bridge.model_bridge") as mock_bridge:
    ...
    def test_export_hf_weights(self):
        ...
        with patch("megatron.bridge.models.model_bridge.stream_weights_megatron_to_hf") as mock_bridge_state:
            ...
            with patch("megatron.bridge.models.causal_bridge.transformers") as mock_transformers:
    ...
    def test_import_ckpt_basic(self, mock_from_hf_pretrained, mock_to_megatron_model, mock_save_megatron_model):
        ...
        # Test import_ckpt
        CausalLMBridge.import_ckpt("meta-llama/Llama-3-8B", "./megatron_checkpoint")
    ...
    def test_import_ckpt_with_kwargs(self, mock_from_hf_pretrained, mock_to_megatron_model, mock_save_megatron_model):
        ...
        CausalLMBridge.import_ckpt(
            "./local_model", "./megatron_checkpoint", torch_dtype=torch.float16, device_map="auto"
        )
